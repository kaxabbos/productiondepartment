...
import com.productiondepartment.model.Users;
import com.productiondepartment.repo.SalesPlansRepo;
import com.productiondepartment.repo.SpecificationsRepo;
import com.productiondepartment.repo.UsersRepo;
...
public class Main {
    ...
    @Autowired
    protected SalesPlansRepo salesPlansRepo;
    @Autowired
    protected SpecificationsRepo specificationsRepo;
    @Value("${upload.img}")
